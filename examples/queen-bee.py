...
plt.savefig("fig/qb_lineage-tree.svg", transparent=True, bbox_inches="tight")
...
plt.savefig("fig/qb_mass-dist.svg", transparent=True, bbox_inches="tight")

# %% trace out lineage sim
stats = TailedSim.trace_lineage("mass_protein", 10)
...
plt.savefig("fig/qb_trace.svg", transparent=True, bbox_inches="tight")
